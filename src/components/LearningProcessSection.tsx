import { hybridModel } from "@/content/site";
  ...
  return (
    <Section id="how-it-works" labelledBy="how-heading">
      ...
      <ol className="relative mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <span
          aria-hidden
          className="spine-track absolute top-[3.25rem] right-[12.5%] left-[12.5%] hidden h-px lg:block"
        />
        ...
        {hybridModel.map((step, i) => (
          <Reveal key={step.title} delay={i * 80} className="h-full">
            <Card
              hover
              as="li"
              className="relative flex h-full list-none flex-col items-center p-6 text-center"
            >
